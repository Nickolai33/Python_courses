...
#         sum += violator_songs_dict[i]
# print(f'Общее время звучания 3 песен "Sweetest Perfection", "Policy of Truth" и "Blue Dress": {round(sum, 2)} минут.')
# for j in violator_songs_dict:
#     if j == 'Halo' or j == 'Enjoy the Silence' or j == 'Clean':
#         sum_2 += violator_songs_dict[j]
# print(f'Общее время звучания 3 песен "Halo", "Enjoy the Silence" и "Clean": {round(sum_2, 2)} минут.')
